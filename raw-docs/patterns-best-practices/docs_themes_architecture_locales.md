---
source: https://shopify.dev/docs/themes/architecture/locales
---
...
## [Anchor to Location](/docs/storefronts/themes/architecture/locales#location)Location
...
## [Anchor to Subtypes](/docs/storefronts/themes/architecture/locales#subtypes)Subtypes

There are two types of locale files:

| Type | Description |
| --- | --- |
| [Storefront](/docs/storefronts/themes/architecture/locales/storefront-locale-files) | Storefront locale files have a `.json` file extension, and control translations for storefront content. These translations can be edited by merchants through the [Shopify Language Editor](https://help.shopify.com/manual/online-store/themes/customizing-themes/language/change-wording#overview-of-the-language-editor). |
| [Schema](/docs/storefronts/themes/architecture/locales/schema-locale-files) | Schema locale files have a `.schema.json` file extension, and control translations for theme editor settings. |

---

## [Anchor to Schema](/docs/storefronts/themes/architecture/locales#schema)Schema

Locale files need to follow a specific [naming structure](#name-locale-files). They also follow a basic organizational structure:
...
"my\_description": "translation text",
...
### [Anchor to Name locale files](/docs/storefronts/themes/architecture/locales#name-locale-files)Name locale files
...
Additionally, you must designate a [default locale file](#the-default-locale-file) for each type.

#### [Anchor to The default locale file](/docs/storefronts/themes/architecture/locales#the-default-locale-file)The default locale file
...
## [Anchor to Requirements and limitations](/docs/storefronts/themes/architecture/locales#requirements-and-limitations)Requirements and limitations
...
## [Anchor to Usage](/docs/storefronts/themes/architecture/locales#usage)Usage

When working with locale files, you should familiarize yourself with referencing locale files. The code for referencing locale files varies depending on whether you're referencing a [storefront locale file](/docs/storefronts/themes/architecture/locales/storefront-locale-files) or a [schema locale file](/docs/storefronts/themes/architecture/locales/schema-locale-files#reference-schema-translations).
