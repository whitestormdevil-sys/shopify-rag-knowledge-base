---
source: https://shopify.dev/docs/apps/build/flow/actions
---

---

## [Anchor to How actions work](/docs/apps/build/flow/actions#how-actions-work)How actions work
...
![A diagram that show how third party actions interface with Flow ](https://cdn.shopify.com/shopifycloud/shopify-dev/production/assets/assets/images/apps/flow/action_diagram-YjW5oA1X.png)


---

## [Anchor to Next steps](/docs/apps/build/flow/actions#next-steps)Next steps
