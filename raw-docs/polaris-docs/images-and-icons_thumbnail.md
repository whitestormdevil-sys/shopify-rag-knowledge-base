---
source: https://polaris.shopify.com/components/images-and-icons/thumbnail
---
...
Thumbnail is now available as a framework-agnostic web component.

[Start using <s-thumbnail>](https://shopify.dev/docs/api/app-home/polaris-web-components/media/thumbnail)

### Thumbnail component examples

DefaultExtra smallSmallLargeWith component source
