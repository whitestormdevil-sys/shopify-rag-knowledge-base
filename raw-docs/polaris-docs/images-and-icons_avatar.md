---
source: https://polaris.shopify.com/components/images-and-icons/avatar
---
...
Avatar is now available as a framework-agnostic web component.

[Start using <s-avatar>](https://shopify.dev/docs/api/app-home/polaris-web-components/media/avatar)

### Avatar component examples

DefaultInitialsExtra small
