---
source: https://polaris.shopify.com/components/typography/text
---
...
Text is now available as a framework-agnostic web component.

[Start using <s-text>](https://shopify.dev/docs/api/app-home/polaris-web-components/titles-and-text/text)

### Text component examples

HeadingBodyAlignWeightToneInheritanceDecoration
...
variant?'headingXs' | 'headingSm' | 'headingMd' | 'headingLg' | 'headingXl' | 'heading2xl' | 'heading3xl (deprecated)' | 'bodyXs' | 'bodySm' | 'bodyMd' | 'bodyLg'
