---
source: https://polaris.shopify.com/components/feedback-indicators/banner
---
...
Banner is now available as a framework-agnostic web component.

[Start using <s-banner>](https://shopify.dev/docs/api/app-home/polaris-web-components/feedback/banner)

### Banner component examples

DefaultDismissibleWith footer call-to-actionInformationalSuccessWarningCriticalIn a modalWith focusIn a card
