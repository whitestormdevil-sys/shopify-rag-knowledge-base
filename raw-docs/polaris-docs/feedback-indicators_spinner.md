---
source: https://polaris.shopify.com/components/feedback-indicators/spinner
---
...
Spinner is now available as a framework-agnostic web component.

[Start using <s-spinner>](https://shopify.dev/docs/api/app-home/polaris-web-components/feedback/spinner)

### Spinner component examples

DefaultSmallWith focus management
