---
source: https://shopify.dev/docs/apps/flow/triggers
---

---

## [Anchor to How triggers work](/docs/apps/build/flow/triggers#how-triggers-work)How triggers work
...
![A diagram that show how third party triggers interface with Flow ](https://cdn.shopify.com/shopifycloud/shopify-dev/production/assets/assets/images/apps/flow/trigger_diagram-eJcDEZaq.png)


---

## [Anchor to Next steps](/docs/apps/build/flow/triggers#next-steps)Next steps
