---
source: https://shopify.dev/docs/api/admin-graphql/latest/objects/SellingPlanGroup
---
...
* {}[DeliveryProfile.sellingPlanGroups](/docs/api/admin-graphql/latest/objects/DeliveryProfile#field-DeliveryProfile.fields.sellingPlanGroups)
* {}[Product.sellingPlanGroups](/docs/api/admin-graphql/latest/objects/Product#field-Product.fields.sellingPlanGroups)
* {}[ProductVariant.sellingPlanGroups](/docs/api/admin-graphql/latest/objects/ProductVariant#field-ProductVariant.fields.sellingPlanGroups)
* <->[SellingPlanGroupConnection.nodes](/docs/api/admin-graphql/latest/connections/SellingPlanGroupConnection#returns-nodes)
* {}[SellingPlanGroupEdge.node](/docs/api/admin-graphql/latest/objects/SellingPlanGroupEdge#field-SellingPlanGroupEdge.fields.node)
